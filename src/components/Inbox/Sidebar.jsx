...
import { ChatItems, Modal } from '../../components';
...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      >
        {/* Top Button */}
        <div className="h-[65px] p-4 border-b border-gray-300 dark:border-gray-700 flex justify-center md:justify-end items-center">
          <button
            onClick={controlModal}
            aria-label="Open Modal"
            className="text-gray-500 dark:text-gray-400 hover:text-violet-600 dark:hover:text-violet-400 transition-colors"
          >
            <svg viewBox="0 0 194.436 194.436" className="w-5 h-5 fill-current">
              <path
